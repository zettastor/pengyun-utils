...
public class SimpleWriteCallback<T> extends AbstractMethodCallback<T> {
  ...
  public SimpleWriteCallback() {
  }

  /**
   * xx.
   */
  public SimpleWriteCallback(Long requestId, Semaphore semaphore) {
